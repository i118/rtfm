# -*- coding: utf-8 -*-
#
# RTFM documentation build configuration file, created by
# sphinx-quickstart on Tue Oct 06 15:22:03 2015.
#
...
html_theme_options = { "roottarget": "index",
	'headtextcolor': '#98aab2',
	'sectiontextcolor': '#000000',
	'sidebar_next_title': u'Следующая страница',
...
latex_documents = [
  (master_doc, 'RTFM.tex', u'RTFM Documentation',
   u'AleX', 'manual'),
]
...
man_pages = [
    (master_doc, 'rtfm', u'RTFM Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RTFM', u'RTFM Documentation',
   author, 'RTFM', 'One line description of project.',
   'Miscellaneous'),
]
